...
def process_video_on_rcp(
    ...
    if video_details is None:
        ...
        return None
    video_information = get_previous_analysis_info(piper_connection, 'kaltura', video_id)
...
def get_kaltura_video_details(db, kaltura_video_id):
    ...
    if kaltura_url_api.startswith('https://www.youtube.com') \
        ...
        if kaltura_url is None:
            ...
            return None
    return dict(
        platform='kaltura', video_id=kaltura_video_id, url=kaltura_url, thumbnail_url=thumbnail_url,
