...
class Captions(unittest.TestCase):
    ...
    def test_initial_disclaimer_new_segment(self):
        from graphai.utils import add_initial_disclaimer
        ...
        subtitles_from_files = self.test_convert_and_combine()
        subtitles_with_disclaimer = add_initial_disclaimer(subtitles_from_files, disclaimer_per_language)
        ...
        for lang, disclaimer in disclaimer_per_language.items():
            self.assertEqual(subtitles_with_disclaimer[0][lang], disclaimer)
    ...
    def test_initial_disclaimer_first_segment_starting_at_0(self):
        ...
        for lang, disclaimer in disclaimer_per_language.items():
            self.assertEqual(subtitles_with_disclaimer[0][lang].split('\n')[0], disclaimer)
